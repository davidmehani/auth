...
import { OAuthScope, ProviderAttribute, UserPool, UserPoolClient, UserPoolClientIdentityProvider, UserPoolDomain, UserPoolIdentityProviderGoogle, UserPoolOperation } from "aws-cdk-lib/aws-cognito";
...
export class CognitoResources extends Construct {
    ...
    private createUserPool(props: CognitoResourcesProps): UserPool {
        ...
        userPool.addTrigger(UserPoolOperation.POST_CONFIRMATION, props.postConfirmationFunction)
    ...
    private createUserPoolClient(userPool: UserPool) {
        ...
        return new UserPoolClient(this, 'UserPoolClient', {
            ...
            oAuth: {
                ...
                callbackUrls: ["https://d3gae6u9fodgq8.cloudfront.net/callback"],
